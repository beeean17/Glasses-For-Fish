...
class CameraSelection:
    ...
    def find_df_min_value(self, df):
        ...
        camera_calibration = CameraCalibration(self.img_path, self.config_file)
        ...
        rms, K, dist_coef, rvecs, tvecs = camera_calibration.calibrate(obj_pts, img_pts, img_size, dist_type=min_column, flags=flags)
